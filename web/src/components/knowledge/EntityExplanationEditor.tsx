      ...
      <section className="space-y-5">
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm leading-5 text-slate-600">
                The reusable short answer for future knowledge reuse.
              </p>
            </div>
            <button
              type="button"
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5">
          <div>
            ...
            <p className="mt-1 text-sm leading-5 text-slate-600">
              Background, tradeoffs, timelines, and caveats that should survive a single review session.
            </p>
          </div>
          <textarea
    ...
    <section className="rounded-xl border border-gray-200 bg-white p-5">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Keep this concise enough to reuse in future evidence-backed summaries.
          </p>
        </div>
        <button
          onClick={onSave}
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          placeholder="Add background, tradeoffs, timelines, and caveats that should survive beyond one review session."
