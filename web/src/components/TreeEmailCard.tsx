...
/**
 * 树形模式邮件卡片：递归渲染一封邮件及其所有 children。
 *
 * 每个节点自带 `details` 折叠控件 + 左侧缩进；批注节点委托给 `ThreadAnnotationCard`。
 * 使用方：`ThreadDrawer` 主组件。
 */
export default function TreeEmailCard({
  node,
  expandedIds,
  highlightedTarget,
  toggleExpand,
