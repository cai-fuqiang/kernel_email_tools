  ...
  return (
    <PageShell wide className="bg-[radial-gradient(circle_at_top_left,_rgba(226,232,240,0.75),_transparent_34%),linear-gradient(180deg,_#f8fafc_0%,_#eef2f7_100%)]">
      ...
      >
        ...
        <div className="grid gap-0 xl:grid-cols-[16rem_minmax(0,1fr)] 2xl:grid-cols-[17rem_minmax(0,1fr)]">
          ...
          <div className="min-w-0 bg-slate-50/60">
            <div className="border-b border-slate-200 px-5 py-5">
              <div className="grid gap-5 2xl:grid-cols-[minmax(0,1.8fr)_22rem] xl:grid-cols-[minmax(0,1.55fr)_21rem]">
                <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div
                    ...
                    className="relative max-h-[68rem] overflow-auto bg-white"
                  >
                  {fileLoading ? (
                      ...
                      {codeLines.map((line, index) => {
                        ...
                        return (
                          <div
                            ...
                            className={`group grid cursor-pointer grid-cols-[20px_72px_minmax(0,1fr)_28px] border-b border-slate-100/80 px-3 ${
                ...
                <aside className="self-start overflow-hidden rounded-2xl border border-slate-200 bg-slate-50/70 shadow-sm">
                  <div className="border-b border-slate-200 px-5 py-4">
                  <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
            ...
            {currentFile && (
              <div className="bg-slate-50/80 px-5 py-5">
                ...
                <div className="grid gap-4 2xl:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1fr)] xl:grid-cols-2">
