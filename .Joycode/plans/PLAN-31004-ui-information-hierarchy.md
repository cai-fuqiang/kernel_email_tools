...
- Search result / Translations completed thread / AnnotationCard 的卡片级 inspector 在移动端使用底部 sheet，避免 375px 下右侧浮层溢出；Search result 默认 snippet 改为 1 行，进一步贴近 ≤84px 高度验收。
