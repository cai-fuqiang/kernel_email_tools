...
| `web/src/components/ThreadDrawer.tsx` | 1611 | 仍超警戒 | 首批拆分完成（PatchDiffBlock / KnowledgeBackRefs / ThreadAnnotationCard 已抽出，-474 行）；LayeredEmailCard (303 行) 和 TreeEmailCard (301 行) 待下一 PR 继续拆 |
